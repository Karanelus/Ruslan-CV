    ...
    <>
      ...
      <div className="bg-orange-100 rounded-lg px-4 py-8 flex flex-col items-center">
        <section className="grid sm:grid-cols-2 sm:grid-rows-1 grid-rows-2 w-full rounded-2xl md:py-4 md:px-8 py-2 px-4 relative">
          ...
          >
            <img src={process.env.PUBLIC_URL + "/img/pluggins/arrow.svg"} alt="Arrow left" className="rotate-180" />
          </button>
          <button
            onClick={onClickArrow}
            value="right"
          ...
          >
            <img src={process.env.PUBLIC_URL + "/img/pluggins/arrow.svg"} alt="Arrow rigth" />
          </button>
        </section>
      </div>
    </>
