const CvAbout = () => {
  return (
    <section className="mb-8 w-section animate-opening rounded-2xl bg-orange-200 bg-gradient-to-r px-8 py-4 md:mb-12 md:px-12 md:py-6">
      <p data-with-indent>
        It can be the simplest "about me" in my life, but sometime mine thoughts
        is not enough to wrote about myself =).
      </p>
      <p data-with-indent>
        I'm Rusłan Karaniewski, who's way in programming only started, but I'm
      ...
      <p data-with-indent>
        ...
        future work can change the world 🌐
      </p>
      <p data-with-indent>
